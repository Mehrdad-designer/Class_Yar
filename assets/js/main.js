...
=============================================*/
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const moreText = document.querySelector(".hidden-text");
...
=============================================*/
    $(".testimonial-active").slick({
        ...
        arrows: true,
        prevArrow:
            '<button type="button" class="slick-prev"><i class="flaticon-right-arrow"></i></button>',
        nextArrow:
...
=============================================*/
    $(".pricing-tab-switcher, .tab-btn").on("click", function () {
        $(".pricing-tab-switcher, .tab-btn").toggleClass("active"),
            ...
            $(".pricing-price, .pricing-price-two").toggleClass(
